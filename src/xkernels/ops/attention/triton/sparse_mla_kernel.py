...
def sparse_mla_attention_triton(
    ...
    *,
    ...
    # Perf pass (#39/#55): BLOCK_N + CDNA3 lowering knobs are resolved from a
    # config (env-overridable for the on-device sweep). T=1 auto-selects the
    # measured single-token decode winner; multi-token keeps the #33 launch
