...
Run on one gfx942 GPU (see ``scripts/archive/issues/probe_fp8_mfma_beverin.sbatch``):

    AMDGCN_ENABLE_DUMP=1 TRITON_ALWAYS_COMPILE=1 python meta/benchmarks/probe_fp8_mfma.py
"""
