...
cards' ``perf.measured`` (meta/docs/library.md §6.2 — the compounding loop).

Numbers are transcribed from meta/wiki/02-benchmarks.md (ms, tflops) and
meta/wiki/03-profiling.md (achieved_bw_pct = ncu DRAM Throughput % on A100). Every
