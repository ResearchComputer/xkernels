...
This script compares documented features in docs/ with the actual codebase in
src/xkernels/ to detect mismatches between documentation and implementation.

Usage:
    python docs/check_document_drift.py
...
class DocumentDriftChecker:
    """Check for document drift between docs/ and src/xkernels/."""
